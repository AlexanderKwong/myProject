...
public class CalendarEx {
	...
	public CalendarEx(final long milsecond) {
		_second = (int)(milsecond/1000);
		_usecond = (int)(milsecond % 1000L)*1000;
	}
	...
	public long compareTo(final CalendarEx other) {
		return (_second - other._second) * 1000000L
	...
	public String timeDiffString(final CalendarEx other) {
		final long value = compareTo(other);
		final int second = (int)(value / 1000000);
		final int vsecond =(int)(value % 1000000);
	...
	public String toString(int flag) {
		...
		{
			str = str + "."
				+ String.format("%03d", _usecond/1000);
		}
	...
	public static void main(final String args[]) {
		...
		jan.util.CalendarEx curTime = new jan.util.CalendarEx(new Date());
		//writeLog.writeLog(LogType.info, "curTime：" + curTime.toString(0));
		//if(curTime.getHour()<3)
			//return;
			
		CalendarEx beginDate = curTime.AddHours(-9);
		while(beginDate.compareTo(curTime.AddHours(-3))<=0)
		{			
			String strDate = beginDate.toString(0).replace(":", "").replace("-", "").replace(" ", "");
			System.out.println("beginDate：" + strDate);
			System.out.println("curTime：" + curTime.toString(0));
