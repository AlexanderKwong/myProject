...
public class Main_SiChuanTemp
{
	...
	public static void main(String args[])
	{
		...
		String MergeStat = args[2];// MERGESTATALL
		String xdrDataPath_http = "NULL";
		String xdrLocationPath = args[4];
		String statType = args.length >= 6 ? args[5] : "";
		int hoursNum = Integer.parseInt(args[6]);

		String mmeKeyWord = "mme";
		String mmeFilter = "mme";
		String httpKeyWord = "mme";
		String httpFilter = "mme";
		String mrKeyWord = "MRO";
		String mrFilter = "";
		...
		if (args.length > 7)
		{
			int hour = Integer.parseInt(args[7]);
			String filterMr = "";
			if ((hour) < 10)
			{
				var[1] = statTime + "0" + hour;
				var[2] += "/sichuan/ods/ns/s1_mme/20" + day + "/0" + hour;
				filterMr += statTime + "0" + hour;
			}
			else
			{
				var[1] = statTime + hour;
				var[2] += "/sichuan/ods/ns/s1_mme/20" + day + "/" + hour;
				filterMr += statTime + hour;
			}
		...
		else
		{
			...
			for (int i = 0; i < times; i++)
			{
				...
				if ((i * hoursNum) < 10)
				{
					var[1] = statTime + "0" + (i * hoursNum);
				}
				else
				{
					var[1] = statTime + (i * hoursNum);
				}
				int count = 0;
				for (int j = 0; j < hoursNum; j++)
				{
					...
					if (count < 10)
					{
						if (j == (hoursNum - 1))
						{
							var[2] += "/sichuan/ods/ns/s1_mme/20" + day + "/0" + count;
							filterMr += statTime + "0" + count;
						}
						else
						{
							var[2] += "/sichuan/ods/ns/s1_mme/20" + day + "/0" + count + ",";
					...
					else
					{
						if (j == (hoursNum - 1))
						{
							var[2] += "/sichuan/ods/ns/s1_mme/20" + day + "/" + count;
							filterMr += statTime + count;
						}
						else
						{
							var[2] += "/sichuan/ods/ns/s1_mme/20" + day + "/" + count + ",";
		...
		{
			SiChuanFileMoverNew.doSiChuanMergestat(statTime, queueName);
		}
	}

	public static void sichuanMain(String[] args) throws Exception
	{
		if (args.length < 6)
		{
		...
		if (checkDoStat("XDRPREPARE"))
		{
			...
			else if (MainModel.GetInstance().getCompile().Assert(CompileMark.GuangXi))
			{
				StringBuffer sb = new StringBuffer();
				for (int i = 0; i < 24; i++)
				{
					if (i < 10)
					{
						sb.append("/wangyou/tmpxdr/mme/20" + statTime.substring(3, 9) + "/0" + i + "/00" + ",");
						sb.append("/wangyou/tmpxdr/mme/20" + statTime.substring(3, 9) + "/0" + i + "/15" + ",");
						sb.append("/wangyou/tmpxdr/mme/20" + statTime.substring(3, 9) + "/0" + i + "/30" + ",");
						sb.append("/wangyou/tmpxdr/mme/20" + statTime.substring(3, 9) + "/0" + i + "/45" + ",");
					}
					else
					{
						sb.append("/wangyou/tmpxdr/mme/20" + statTime.substring(3, 9) + "/" + i + "/00" + ",");
						sb.append("/wangyou/tmpxdr/mme/20" + statTime.substring(3, 9) + "/" + i + "/15" + ",");
						sb.append("/wangyou/tmpxdr/mme/20" + statTime.substring(3, 9) + "/" + i + "/30" + ",");
						sb.append("/wangyou/tmpxdr/mme/20" + statTime.substring(3, 9) + "/" + i + "/45" + ",");
					}
				}
				myArgs[3] = sb.toString().substring(0, sb.toString().length() - 1);
				...
				for (int i = 0; i < 24; i++)
				{
					if (i < 10)
					{
						sb1.append("/wangyou/tmpxdr/http/20" + statTime.substring(3, 9) + "/0" + i + "/00" + ",");
						sb1.append("/wangyou/tmpxdr/http/20" + statTime.substring(3, 9) + "/0" + i + "/15" + ",");
						sb1.append("/wangyou/tmpxdr/http/20" + statTime.substring(3, 9) + "/0" + i + "/30" + ",");
						sb1.append("/wangyou/tmpxdr/http/20" + statTime.substring(3, 9) + "/0" + i + "/45" + ",");
					}
					else
					{
						sb1.append("/wangyou/tmpxdr/http/20" + statTime.substring(3, 9) + "/" + i + "/00" + ",");
						sb1.append("/wangyou/tmpxdr/http/20" + statTime.substring(3, 9) + "/" + i + "/15" + ",");
						sb1.append("/wangyou/tmpxdr/http/20" + statTime.substring(3, 9) + "/" + i + "/30" + ",");
						sb1.append("/wangyou/tmpxdr/http/20" + statTime.substring(3, 9) + "/" + i + "/45" + ",");
					}
				}
				myArgs[4] = sb1.toString().substring(0, sb1.toString().length() - 1);
			}
		...
		if (checkDoStat("MROFORMATMT"))
		{
			...
			else if (MainModel.GetInstance().getCompile().Assert(CompileMark.GuangXi))
			{
				...
				for (int i = 0; i < 24; i++)
				{
					if (i < 10)
					{
						sb.append("/wangyou/tmpxdr/mro/20" + statTime.substring(3, 9) + "/0" + i + ",");
					}
					else
					{
						sb.append("/wangyou/tmpxdr/mro/20" + statTime.substring(3, 9) + "/" + i + ",");
					}
				}
				myArgs[3] = sb.toString().substring(0, sb.toString().length() - 1);
		...
		if (checkDoStat("MROLOC_NEW"))
		{
			...
			// if
			// (MainModel.GetInstance().getCompile().Assert(CompileMark.NoMtMro)
			// ||
