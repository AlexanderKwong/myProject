...
public class Stat_Location_4G
{

	public int icityid;
	public int startTime;
	public int endTime;
	public long isamplenum;
	...
	public Map<Integer, Map<String, MyInt>> origLocTypeMap;
	public Map<Integer, Map<String, MyInt>> locTypeMap;

	public Stat_Location_4G()
	{
		Clear();
	}
	...
	public void Clear()
	{
		origLocTypeMap = new HashMap<Integer, Map<String, MyInt>>();
	};
