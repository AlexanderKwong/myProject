...
public class Stat_CellGrid_4G
{
	...
	public int XdrCount;
	public int MrCount;
	// add new chong die fu gai 20170531
	public int overlapnum = 0; // 分子
	public int overlapden = 0; // 分母
	...
	public static Stat_CellGrid_4G FillData(String[] values, int startPos)
	{
		...
		{
			item.overlapnum = Integer.parseInt(values[i++]);
		}
		if (i <= values.length - 1)
		{
			item.overlapden = Integer.parseInt(values[i++]);
		}
		return item;
	}
