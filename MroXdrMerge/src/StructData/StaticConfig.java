...
// new String[] { "", "AM", "BM", "BT", "CF", "EEDS", "HLBE", "HHHT", "TL", "WM", "XM", "XAM", "WH" };
	...
	public static void putCityNameByCityId(){
		if(cityId_Name==null){
			...
			cityId_Name.put(1529, "AM");cityId_Name.put(1508, "BM");cityId_Name.put(1502, "BT");
			cityId_Name.put(1504, "CF");cityId_Name.put(1506, "EEDS");cityId_Name.put(1507, "HLBE");
			cityId_Name.put(1501, "HHHT");cityId_Name.put(1505, "TL");cityId_Name.put(1509, "WM");
			cityId_Name.put(1525, "XM");cityId_Name.put(1522, "XAM");cityId_Name.put(1503, "WH");
		}
	}
