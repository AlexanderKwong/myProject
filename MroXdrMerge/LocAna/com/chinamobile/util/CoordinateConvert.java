...
public class CoordinateConvert {
    ...
    // WGS84=》GCJ02   地球坐标系=>火星坐标系
       ...
       //GCJ02=>WGS84   火星坐标系=>地球坐标系（精确）
        ...
        {
        	double[] dd =  bd092WGS(46.45969601,125.2030821);
        	System.out.println(dd[1] + "," + dd[0]);
        	
        	
        	//double[] dd2 =  wgs2GCJ(30.76086, 104.07505);
        	//System.out.println(dd2[1] + "," + dd2[0]);        

        	
        	double[] dd3 =  wgs2BD09(46.4459619,125.1858353);
        	System.out.println(dd3[1] + "," + dd3[0]);        
