...
public class DayDataDeal_4G_DX
{
	...
	public class DayDataItem
	{
		...
		public DayDataItem(TypeResult typeResult, int stime, int etime)
		{
			...
			statdoList.add(new OutGridStatDo_4G(typeResult, StaticConfig.SOURCE_DX));
			statdoList.add(new InGridStatDo_4G(typeResult, StaticConfig.SOURCE_DX));
			statdoList.add(new BuildStatDo_4G(typeResult, StaticConfig.SOURCE_DX));
			statdoList.add(new CellStatDO_4G(typeResult, StaticConfig.SOURCE_DX));
		}
