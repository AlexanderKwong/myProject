...
public class SceneMergeDo implements IMergeDataDo
{
	...
	public String getMapKey()
	{
		...
		sbTemp.append("_");
		sbTemp.append(TimeHelper.getRoundDayTime(scene.iTime));
	...
	public boolean mergeData(Object o)
	{
		...
		// scene.iMRCnt_Out_URI += temp.scene.iMRCnt_Out_URI;
		// scene.iMRCnt_Out_SDK += temp.scene.iMRCnt_Out_SDK;
		// scene.iMRCnt_Out_HIGH += temp.scene.iMRCnt_Out_HIGH;
		// scene.iMRCnt_Out_SIMU += temp.scene.iMRCnt_Out_SIMU;
		// scene.iMRCnt_Out_Other += temp.scene.iMRCnt_Out_Other;
		// scene.iMRCnt_In_URI += temp.scene.iMRCnt_In_URI;
		// scene.iMRCnt_In_SDK += temp.scene.iMRCnt_In_SDK;
		// scene.iMRCnt_In_WLAN += temp.scene.iMRCnt_In_WLAN;
		// scene.iMRCnt_In_SIMU += temp.scene.iMRCnt_In_SIMU;
		// scene.iMRCnt_In_Other += temp.scene.iMRCnt_In_Other;
