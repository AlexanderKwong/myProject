...
public class SceneGridMergeDo implements IMergeDataDo
{
	...
	public String getMapKey()
	{
		...
		sbTemp.append("_");
		sbTemp.append(TimeHelper.getRoundDayTime(sceneGrid.iTime));
	...
	public boolean mergeData(Object o)
	{
		...
		// sceneGrid.iMRCnt_Out_URI += temp.sceneGrid.iMRCnt_Out_URI;
		// sceneGrid.iMRCnt_Out_SDK += temp.sceneGrid.iMRCnt_Out_SDK;
		// sceneGrid.iMRCnt_Out_HIGH += temp.sceneGrid.iMRCnt_Out_HIGH;
		// sceneGrid.iMRCnt_Out_SIMU += temp.sceneGrid.iMRCnt_Out_SIMU;
		// sceneGrid.iMRCnt_Out_Other += temp.sceneGrid.iMRCnt_Out_Other;
	...
	{
		// TODO Auto-generated method stub
		return sceneGrid.roundDayToLine();
	}
