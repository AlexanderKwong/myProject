...
public class SceneCellGridMergeDo implements IMergeDataDo
{
	...
	public boolean mergeData(Object o)
	{
		...
		if ((sceneCellGrid.fRSRPMin == StaticConfig.Int_Abnormal) || (temp.sceneCellGrid.fRSRPMin < sceneCellGrid.fRSRPMin && temp.sceneCellGrid.fRSRPMin != StaticConfig.Int_Abnormal))
		{
		...
		if ((sceneCellGrid.fRSRQMin == StaticConfig.Int_Abnormal) || (temp.sceneCellGrid.fRSRQMin < sceneCellGrid.fRSRQMin && temp.sceneCellGrid.fRSRQMin != StaticConfig.Int_Abnormal))
		{
		...
		if ((sceneCellGrid.fSINRMin == StaticConfig.Int_Abnormal) || (temp.sceneCellGrid.fSINRMin < sceneCellGrid.fSINRMin && temp.sceneCellGrid.fSINRMin != StaticConfig.Int_Abnormal))
		{
	...
	{
		return sceneCellGrid.roundDayToLine();
	}
