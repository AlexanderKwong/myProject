...
public class InGridMergeDo implements IMergeDataDo
{
	...
	public boolean mergeData(Object o)
	{
		...
		if ((ingrid.fSINRMin == StaticConfig.Int_Abnormal) || (temp.ingrid.fSINRMin < ingrid.fSINRMin && temp.ingrid.fSINRMin != StaticConfig.Int_Abnormal))
		{
