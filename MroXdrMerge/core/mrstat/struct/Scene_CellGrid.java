...
public class Scene_CellGrid extends Stat_OutGrid
{
	...
	public String toLine()
	{
		...
		bf.append(iRSRQ_14);
		// bf.append(spliter);
		// bf.append(iASNei_MRCnt);
		// bf.append(spliter);
		// bf.append(fASNei_RSRPValue);
		bf.append(spliter);
	 ...
	 * @param ncrsrp
	 */
	// public void doNcRsrp(float ncrsrp)
	// {
	// iASNei_MRCnt++;
	// fASNei_RSRPValue += ncrsrp;
	// }
	...
	public static Scene_CellGrid FillData(String[] vals, int pos)
	{
		...
		// outcellGrid.iMRCnt_Out_URI = Integer.parseInt(vals[i++]);
		// outcellGrid.iMRCnt_Out_SDK = Integer.parseInt(vals[i++]);
		// outcellGrid.iMRCnt_Out_HIGH = Integer.parseInt(vals[i++]);
		// outcellGrid.iMRCnt_Out_SIMU = Integer.parseInt(vals[i++]);
		// outcellGrid.iMRCnt_Out_Other = Integer.parseInt(vals[i++]);
		...
		// outcellGrid.iASNei_MRCnt = Integer.parseInt(vals[i++]);
		// outcellGrid.fASNei_RSRPValue = Float.parseFloat(vals[i++]);
