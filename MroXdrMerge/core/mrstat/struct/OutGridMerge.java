...
public class OutGridMerge implements IMergeDataDo
{
	...
	public boolean mergeData(Object o)
	{
		...
		if ((outgrid.fSINRMin == StaticConfig.Int_Abnormal) || (temp.outgrid.fSINRMin < outgrid.fSINRMin && temp.outgrid.fSINRMin != StaticConfig.Int_Abnormal))
		{
