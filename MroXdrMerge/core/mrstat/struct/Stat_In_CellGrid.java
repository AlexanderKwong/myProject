...
public class Stat_In_CellGrid
{
	...
	public static Stat_In_CellGrid FillData(String[] vals, int pos)
	{
		...
		// incellGrid.iMRCnt_In_URI = Integer.parseInt(vals[i++]);
		// incellGrid.iMRCnt_In_SDK = Integer.parseInt(vals[i++]);
		// incellGrid.iMRCnt_In_WLAN = Integer.parseInt(vals[i++]);
		// incellGrid.iMRCnt_In_SIMU = Integer.parseInt(vals[i++]);
		// incellGrid.iMRCnt_In_Other = Integer.parseInt(vals[i++]);
