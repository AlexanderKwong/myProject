...
public class Stat_OutGrid
{
	...
	public int iTime;
	public int iMRCnt;
	// public int iMRCnt_Out_URI;
	// public int iMRCnt_Out_SDK;
	// public int iMRCnt_Out_HIGH;
	// public int iMRCnt_Out_SIMU;
	// public int iMRCnt_Out_Other;
	...
	public void doSample(int rsrp, int rsrq, int sinr, int Overlap, int OverlapAll)
	{
		...
		// if (locSource == StaticConfig.LOCTYPE_FG)
		// {
		// iMRCnt_Out_SIMU++;
		// }
		// else if (locSource == StaticConfig.LOCTYPE_GPS)
		// {
		// iMRCnt_Out_HIGH++;
		// }
		// else if (locSource == StaticConfig.LOCTYPE_OTT)
		// {
		// iMRCnt_Out_URI++;
		// }
		if (rsrq != -1000000)
	...
	public static Stat_OutGrid FillData(String[] vals, int pos)
	{
		...
		// outGrid.iMRCnt_Out_URI = Integer.parseInt(vals[i++]);
		// outGrid.iMRCnt_Out_SDK = Integer.parseInt(vals[i++]);
		// outGrid.iMRCnt_Out_HIGH = Integer.parseInt(vals[i++]);
		// outGrid.iMRCnt_Out_SIMU = Integer.parseInt(vals[i++]);
		// outGrid.iMRCnt_Out_Other = Integer.parseInt(vals[i++]);
