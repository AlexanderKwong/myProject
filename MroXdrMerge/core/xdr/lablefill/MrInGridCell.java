...
public class MrInGridCell implements IResultTable
{
	...
	public MrInGridCell(DT_Sample_4G sample, int statTime)
	{
	...
	public static final String TypeName = "mringridcell";
	...
	{
		String key = MrInGridCellNc.getKey(this, nclte);
		MrInGridCellNc item = (MrInGridCellNc) map.get(key);
		if (item == null)
		{
			item = new MrInGridCellNc(this, nclte);
			map.put(key, item);
		}
