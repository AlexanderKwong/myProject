...
import StructData.Stat_Location_4G;
	...
	public void dealSample(DT_Sample_4G sample)
	{
		...
		else
		{
			...
			if(sample.ilongitude > 0 && sample.isOriginalLoction())
			{
			    ...
			    if(sample.loctp.equals("ll") || sample.loctp.equals("ll2") || sample.loctp.equals("wf")
				...
				MyInt count = null;
				count = loctpMap.get(sample.loctp);
				if(count == null)
				{
					count = new MyInt(0);
					loctpMap.put(sample.loctp, count);
				}
