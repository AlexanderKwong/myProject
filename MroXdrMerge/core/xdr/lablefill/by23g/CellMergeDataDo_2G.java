...
public class CellMergeDataDo_2G implements IMergeDataDo
{
	private int dataType = 0;
	public Stat_Cell_2G statItem = new Stat_Cell_2G();
	...
	{
		CellMergeDataDo_2G tmpItem = (CellMergeDataDo_2G)o;
		if(tmpItem == null)
		{
			return false;
		}
	...
	{	
		return ResultHelper.getPutCell_2G(statItem);
	}
