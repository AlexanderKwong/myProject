...
public class CellGridMergeDataDo_3G implements IMergeDataDo
{
	private int dataType = 0;
	public Stat_CellGrid_3G statItem = new Stat_CellGrid_3G();
	...
	{
		CellGridMergeDataDo_3G tmpItem = (CellGridMergeDataDo_3G)o;
		if(tmpItem == null)
		{
			return false;
		}
	...
	{	
		return ResultHelper.getPutCellGrid_3G(statItem);
	}
