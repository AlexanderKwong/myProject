...
public class GridMergeDataDo_2G implements IMergeDataDo
{
	private int dataType = 0;
	public Stat_Grid_2G statItem = new Stat_Grid_2G();
	...
	{
		GridMergeDataDo_2G tmpItem = (GridMergeDataDo_2G)o;
		if(tmpItem == null)
		{
			return false;
		}
	...
	{	
		return ResultHelper.getPutGrid_2G(statItem);
	}
