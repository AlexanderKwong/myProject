...
public class EventDataAreaGridStat extends AStatDo
{
	...
	public EventDataAreaGridStat(int stime, int etime, String resultTBName, MultiOutputMng<NullWritable, Text> mosMng)
	{
		this.stime = stime;
		this.etime = etime;
		this.mosMng = mosMng;
...
//		}
	...
	public class EventDataAreaGrid extends EventDataStatDo
	{
