...
public class EventDataOutCellGridStat extends AStatDo
{
	...
	public EventDataOutCellGridStat(int stime, int etime, String resultTBName, MultiOutputMng<NullWritable, Text> mosMng)
	{
		this.stime = stime;
		this.etime = etime;
		this.mosMng = mosMng;
	...
	public class EventDataOutCellGrid extends EventDataStatDo
	{
		...
		public EventDataOutCellGrid(int iCityID, int iLongitude, int iLatitude,int iBRlongitude ,int iBRlatitude , int iECI, int iTime)
		{
			super();
