...
//			conf.set("mapreduce.reduce.shuffle.fetch.retry.enabled", "true");
//			conf.set("mapreduce.reduce.shuffle.fetch.retry.interval-ms", "10000");
//			conf.set("mapreduce.reduce.shuffle.fetch.retry.timeout-ms", "120000");
//			conf.set("yarn.app.mapreduce.client-am.ipc.max-retries", "6");
//			conf.set("yarn.app.mapreduce.client-am.ipc.max-retries-on-timeouts", "6");
//			conf.set("mapreduce.reduce.shuffle.parallelcopies", "10");
//			conf.set("mapreduce.reduce.shuffle.connect.timeout", "360000");
//			conf.set("mapreduce.reduce.shuffle.read.timeout", "360000");
