...
public class StringUtil
{
    ...
    {    	   		
		String hex = "7fffffffffffffff";
		long eci = StringUtil.hexString8ToUnsignedLong(hex);
		System.out.println(eci);
		
		hex = "fffffffffffffffff";
		eci = StringUtil.hexString8ToUnsignedLong(hex);
		System.out.println(EncryptStringToLong(""));
		System.out.println(EncryptStringToLong("13812341234"));
