...
public class ImeiCellTimesKey implements WritableComparable<ImeiCellTimesKey>
{
	public long imsi;
	public long dayhour; // 小时时间
	public long eci;

	public ImeiCellTimesKey()
	{
	}
	 ...
	 * @param eci
	 */
	public ImeiCellTimesKey(long imsi, long dayhour, long eci)
	{
		this.imsi = imsi;
	...
	@Override
	public int compareTo(ImeiCellTimesKey o)
	{
	...
	public boolean equals(Object obj)
	{
		...
		else if (obj instanceof ImeiCellTimesKey)
		{
			ImeiCellTimesKey s = (ImeiCellTimesKey) obj;
