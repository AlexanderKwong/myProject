...
{
	public static class MroMapper_ERICSSON extends DataDealMapper<Object, Text, CellTimeKey, Text>
	{
		private long eci = 0;
		private int time = 0;
		...
		public void map(Object key, Text value, Context context) throws IOException, InterruptedException
		{
			...
			try
			{
				...
				mrokey = new CellTimeKey(eci, time / TimeSpan * TimeSpan, 5);
	...
	public static class MroMapper_HUAWEI_TD extends DataDealMapper<Object, Text, CellTimeKey, Text>
	{
		private long eci = 0;
		private int time = 0;
		private final int TimeSpan = 600;// 10分钟间隔
	...
	public static class MroMapper_NSN_TD extends DataDealMapper<Object, Text, CellTimeKey, Text>
	{
		private long eci = 0;
		private int time = 0;
		private final int TimeSpan = 600;// 10分钟间隔
	...
	public static class MroMapper_ZTE_TD extends DataDealMapper<Object, Text, CellTimeKey, Text>
	{
		private long eci = 0;
		private int time = 0;
		private final int TimeSpan = 600;// 10分钟间隔
