...
public class DataDealConfiguration extends Configuration
{
	...
	public static Configuration create(String appBasePath, final Configuration conf)
	{
		...
		// 筛除无效的文件
		conf.set("mapreduce.input.pathFilter.class", "jan.com.hadoop.mapred.TmpFileFilter");
	...
	protected static void addNamedOutput(Configuration conf, String namedOutput, Class<? extends OutputFormat> outputFormatClass,
